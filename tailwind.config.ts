 ...
 * --------------------------
 * This configuration extends Tailwind's default theme with our CSS variables
 * for a consistent design system across the application.
 */
const config: Config = {
  // Enable dark mode using class strategy (vs media queries)
  darkMode: 'class',
  
  // Process these files with Tailwind
  content: [
